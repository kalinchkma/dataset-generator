...
def save_output(image_name, pred, d_dir, orgina_image):
    predict = pred
...
def removeBackground(sourceFolder, destinationFolder):
    ...
    image_dir = os.path.join(os.getcwd(), sourceFolder)
    prediction_dir = os.path.join(os.getcwd(), destinationFolder + os.sep)
    ...
    for i_test, data_test in enumerate(test_salobj_dataloader):
        ...
        orgina_image = Image.open(img_name_list[i_test])
        ...
        save_output(img_name_list[i_test], pred, prediction_dir, orgina_image)
